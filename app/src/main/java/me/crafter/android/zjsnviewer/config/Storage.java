...
public class Storage {
    ...
    public static String[] str_idle = {"空闲中","空闲中","閒置中","Idle","未使用","-","无所事事中"};
    ...
    public static String[] str_travel = {"远征中 - ","远征中 - ","遠征中 - ","Exp.ing - ","遠征中 - ","","外出中"};
    public static String[] str_repair = {"修理中 - ","修理中 - ","修理中 - ","Reparing - ","入渠中 - ","","洗澡中"};
    public static String[] str_build = {"建造中 - ","建造中 - ","建造中 - ","Cons.ing - ","建造中 - ","","换装中"};
    public static String[] str_make = {"开发中 - ","开发中 - ","開發中 - ","Cons.ing - ","開発中 - ","","缝制中"};
    ...
    public static String[] str_make2 = {"开发完成","开发完成","開發完成","Construction Complete","開壳完了","00:00","衣服在这里"};
